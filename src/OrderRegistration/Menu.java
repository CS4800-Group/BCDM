...
public class Menu {
	...
	public Menu() {
		...
		this.fries = "Fries";
		this.cookie = "Cookie";
		this.iceCream = "Ice Cream";
		this.beverage = "Beverage";
		this.water = "Water";
		
		this.pizzaPrice = 5.99;
		this.chickenPrice = 4.99;
		this.burgerPrice = 6.99;
		this.sandwichPrice = 5.99;
		this.friesPrice = 3.99;
		this.cookiePrice = 2.99;
		this.iceCreamPrice = 2.99;
		this.beveragePrice = 1.99;
		this.waterPrice = 0.99;
	}
